...
const NFT = () => {
    return (
        <div className="h-screen w-full flex flex-col items-center justify-center bg-black text-center relative overflow-y-hidden px-4 py-3 gap-6 sm:gap-5 md:gap-6 lg:gap-8">
            ...
            <div className="flex-shrink-0 max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl">
                <p className="text-white/70 text-sm sm:text-base md:text-lg lg:text-xl font-normal leading-loose sm:leading-relaxed px-1">
                    ...
                    <span className="text-[#ccff00] font-normal">Coinguard's AI-driven Solana-based NFT Generator</span>.
                </p>
            </div>
            ...
            {/* <p className="text-white/80 text-xs sm:text-sm md:text-base lg:text-lg">
                Solana-based NFT Generation
            </p> */}

            {/* NFT Features */}
            {/* <div className="w-full max-w-3xl z-10 px-2 sm:px-0">
                <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold text-[#ccff00] mb-1">
                    NFT Features
                </h3>
                <p className="text-white/70 text-xs sm:text-sm md:text-base lg:text-lg leading-snug font-normal">
                    Create, manage, and showcase NFTs with{" "}
                    <span className="text-[#ccff00] font-normal">AI-Powered Creation</span>,{" "}
                    <span className="text-[#ccff00] font-normal">Secure Minting</span>,{" "}
                    <span className="text-[#ccff00] font-normal">Model & Style Selection</span>, and the{" "}
                    <span className="text-[#ccff00] font-normal">NFT Gallery</span>.
                </p>
            </div> */}
