...
const Navbar = () => {
  ...
  return (
    <>
      {/* TOP NAVBAR */}
      <nav className="text-white font-['DM_Sans'] fixed top-[45px] left-0 right-0 z-50 pt-2 md:pt-4 pb-2">
      ...
      {/* MOBILE DROPDOWN */}
      <div
        className={`fixed top-[8.5rem] left-1/2 font-['DM_Sans'] bg-[rgb(17,17,17)] rounded-xl shadow-lg z-40 transition-all duration-300 ease-in-out transform -translate-x-1/2
